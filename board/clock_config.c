...
- {id: FRO_HF_clock.outFreq, value: 48 MHz}
- {id: MAIN_clock.outFreq, value: 144 MHz}
- {id: PLL0_CLK_clock.outFreq, value: 144 MHz}
- {id: PLL1_CLK_clock.outFreq, value: 144 MHz}
- {id: SAI1_clock.outFreq, value: 48 MHz}
- {id: Slow_clock.outFreq, value: 36 MHz}
- {id: System_clock.outFreq, value: 144 MHz}
- {id: gdet_clock.outFreq, value: 48 MHz}
- {id: pll1_clk0_clock.outFreq, value: 144 MHz}
- {id: pll1_clk1_clock.outFreq, value: 144 MHz}
- {id: trng_clock.outFreq, value: 48 MHz}
settings:
...
- {id: PLL1CLK1DIV_HALT, value: Enable}
- {id: PLLCLKDIV_HALT, value: Enable}
- {id: SAI1CLKDIV, value: Enable}
- {id: SCG.PLL0M_MULT.scale, value: '6', locked: true}
- {id: SCG.PLL0SRCSEL.sel, value: SCG.FIRC_48M}
- {id: SCG.PLL0_NDIV.scale, value: '1', locked: true}
- {id: SCG.PLL0_PDIV.scale, value: '2', locked: true}
- {id: SCG.PLL1M_MULT.scale, value: '6', locked: true}
- {id: SCG.PLL1SRCSEL.sel, value: SCG.FIRC_48M}
- {id: SCG.PLL1_NDIV.scale, value: '1', locked: true}
...
- {id: SYSCON.FREQMEREFCLKSEL.sel, value: SYSCON.evtg_out0a}
- {id: SYSCON.FREQMETARGETCLKSEL.sel, value: SYSCON.evtg_out0a}
- {id: SYSCON.PLL1CLK0DIV.scale, value: '1', locked: true}
- {id: SYSCON.SAI1CLKDIV.scale, value: '3', locked: true}
- {id: SYSCON.SAI1CLKSEL.sel, value: SCG.PLL0_CLK}
 * BE CAREFUL MODIFYING THIS COMMENT - IT IS YAML SETTINGS FOR TOOLS **********/
/* clang-format on */
...
void BOARD_BootClockPLL150M(void)
{
    ...
    const pll_setup_t pll0Setup = {
        .pllctrl = SCG_APLLCTRL_SOURCE(1U) | SCG_APLLCTRL_SELI(5U) | SCG_APLLCTRL_SELP(2U),
        .pllndiv = SCG_APLLNDIV_NDIV(1U),
        .pllpdiv = SCG_APLLPDIV_PDIV(1U),
        .pllmdiv = SCG_APLLMDIV_MDIV(6U),
        .pllRate = 144000000U
    };
    ...
    const pll_setup_t pll1Setup = {
        .pllctrl = SCG_SPLLCTRL_SOURCE(1U) | SCG_SPLLCTRL_SELI(5U) | SCG_SPLLCTRL_SELP(2U),
        .pllndiv = SCG_SPLLNDIV_NDIV(1U),
        .pllpdiv = SCG_SPLLPDIV_PDIV(1U),
        .pllmdiv = SCG_SPLLMDIV_MDIV(6U),
        .pllRate = 144000000U
    };
    ...
    CLOCK_AttachClk(kFRO12M_to_FLEXCOMM2);                 /*!< Switch FLEXCOMM2 to FRO12M */
    CLOCK_AttachClk(kPLL0_to_SAI1);                 /*!< Switch SAI1 to PLL0 */

    /*!< Set up dividers */
    CLOCK_SetClkDiv(kCLOCK_DivAhbClk, 1U);           /*!< Set AHBCLKDIV divider to value 1 */
    CLOCK_SetClkDiv(kCLOCK_DivFlexcom2Clk, 1U);           /*!< Set FLEXCOMM2CLKDIV divider to value 1 */
    CLOCK_SetClkDiv(kCLOCK_DivPLL1Clk0, 1U);           /*!< Set PLL1CLK0DIV divider to value 1 */
    CLOCK_SetClkDiv(kCLOCK_DivPLL1Clk1, 1U);           /*!< Set PLL1CLK1DIV divider to value 1 */
    CLOCK_SetClkDiv(kCLOCK_DivSai1Clk, 3U);           /*!< Set SAI1CLKDIV divider to value 3 */
